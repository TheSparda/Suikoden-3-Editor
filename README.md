...
**Field pickups hang as Koroku — and there's now a patch for it.** Picking up a herb or
looting a skeleton freezes: the same *walk up, press X, get an item* interaction both times.
