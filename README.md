...
**Unites**, **Mounts** (which rider sits on which mount in battle — the game hard-codes exactly
three pairs, stock *Hugo+Fubar / Futch+Bright / Franz+Ruby*, and this rewrites those three
comparisons; see below), **Gear** (DEF, price, 5 effect slots), **Sets** (armor-set composition, the
